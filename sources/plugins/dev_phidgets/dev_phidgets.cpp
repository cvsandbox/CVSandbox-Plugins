...
#include <imodule.h>
#include "image_phidgets_16x16.h"

// Descriptor of the module
ModuleDescriptor moduleInfo =
{
    { 0xAF000001, 0x00000000, 0x00000000, 0x80000001 },
    { 1, 0, 0 },
    "Phidgets Devices",
    "dev_phidgets",
    "The module contains plug-ins to access different Phidgets devices.",
    "Computer Vision Sandbox",
    "Copyright Computer Vision Sandbox, 2011-2019",
    "http://www.cvsandbox.com/",
    (ximage*) &image_phidgets_16x16, // small icon
    nullptr, // icon
    0
};
