...
#ifndef CVS_PHIDGET_ADVANCED_SERVO_PLUGIN_HPP
#define CVS_PHIDGET_ADVANCED_SERVO_PLUGIN_HPP
...
class PhidgetAdvancedServoPlugin : public IDevicePlugin
{
public:
...
private:
    ...
    ::Private::PhidgetAdvancedServoPluginData* mData;
};

#endif // CVS_PHIDGET_ADVANCED_SERVO_PLUGIN_HPP
